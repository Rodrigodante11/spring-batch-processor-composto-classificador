package com.rodrigo.springbatch.processadorclassifier.reader;

import java.util.HashMap;
import java.util.Map;

import com.rodrigo.springbatch.processadorclassifier.dominio.Cliente;
import com.rodrigo.springbatch.processadorclassifier.dominio.Transacao;
